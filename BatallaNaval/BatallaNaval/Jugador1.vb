...
Public Class Jugador1
    ...
    Private _xDatos As Barquito.BatallaNavalGuardada
    ...
    End Sub
    Private Sub Jugador1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        SetupDataGridView()
        If Me.partidaGuardada Then
            Me.CargarDatosArchivo()
        End If
        GenerarDatos()
        Me.BarquitoSingleton = New Barquito()
    ...
    Public Sub CargarDatosArchivo()
        ...
        Dim xDatos As Barquito.BatallaNavalGuardada = Me.BarquitoSingleton.LeerArchivo("Jugador 1")
        Dim sFilaString(Me.cantFilas) As String
        Dim sI As Integer = 0
    ...
    Private Sub chGuardarPartida_CheckedChanged(sender As Object, e As EventArgs) Handles chGuardarPartida.CheckedChanged
        ...
        For x As Integer = 0 To Me.DataGridJ1.Rows.Count() - 1
            ...
            Next
        Next
        Me.BarquitoSingleton.GrabarArchivoJuego(matrixDat, Me.cantFilas, Me.cantColumnas, "Jugador 1")
    End Sub
End Class